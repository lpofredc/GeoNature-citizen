export const AppConfig = {
    ...
    API_TAXHUB:"http://geonature.fauneauvergnerhonealpes.org/taxhub/api",
    FRONTEND:{
        PROD_MOD:true,
        MULTILINGUAL:false,
        DISPLAY_FOOTER: true,
    ...
    details_espece_url: "https://carto.fauneauvergnerhonealpes.org/espece/", // !! gardez bien le cd_nom/ dans l'url
